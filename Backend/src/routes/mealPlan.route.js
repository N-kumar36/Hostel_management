...
import { selectPackage, getAllSubscriptions, getManagerSubscriptions, updateSubscriptionByManager, deleteSubscriptionByManager, compileAllSubscriptions } from "../controllers/StudentSubscription.controller.js";
...
router.post("/manager/compile-all", protect, compileAllSubscriptions); // Updated route with permission check
