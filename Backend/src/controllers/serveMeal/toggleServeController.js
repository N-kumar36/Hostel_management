...
export const toggleServeStatus = async (req, res) => {
    try {
        ...
        if (!existingVote) {
            ...
            // Buat log history baru untuk manager yang sedang aktif melakukan klik tombol
            const historyLog = {
            ...
            // Eksekusi update atomik ke dalam array sub-document MongoDB
        ...
        await syncSubscriptionQuota(subscription, isNowServed, subscriptionKey, forceFineBilling);
