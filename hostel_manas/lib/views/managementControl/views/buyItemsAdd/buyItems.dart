...
class _BuyItemsPageState extends State<BuyItemsPage> {
  ...
  //  Fetch all shopping items from backend database
  ...
  // ✏️ Update an existing item's text or toggle status
  ...
  // ❓ Internal helper to show a modern confirmation alert dialog box
                          ...
                          child: ListTile(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                // Wrapped in a Wrap widget to keep the layout responsive and elegant
                                Wrap(
                                  spacing: 12,
                                  runSpacing: 4,
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(width: 4),
                                        Text(
                                          // Reads the populated name object safely from the json map layout
                                          item['createdBy'] != null &&
                                                  item['createdBy']['name'] !=
                                                      null
                                              ? "By: ${item['createdBy']['name']}"
                                              : "By: Unknown Admin or Manager",
                                          style: TextStyle(
                                            fontSize: 11,
                                            color: isBought
                                                ? Colors.grey.shade400
                            ...
                            trailing: Row(
                              ...
                              children: [
                                ...
                                IconButton(
                                  ...
                                  onPressed: () =>
                                      _showItemFormSheet(context, index: index),
